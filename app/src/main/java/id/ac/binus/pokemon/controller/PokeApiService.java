...
public class PokeApiService {
    ...
    public static void getCapturedPokemonDataFromAPIByName(String id, String name, OnPokemonLoadedListener listener, Integer level, Integer maxHp, Integer Hp, Integer attackStats){
